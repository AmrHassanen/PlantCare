...
namespace Rootics.Core.Models
{
    ...
    {
        public int Id { get; set; } // Unique identifier for the disease
        ...
        // Navigation property for relating PlantDisease to a single Plant
        public Plant Plant { get; set; }
        // Navigation property for relating PlantDisease to multiple Treatments
